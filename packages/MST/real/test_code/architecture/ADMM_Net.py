...
class double_conv(nn.Module):
    ...
    def __init__(self, in_channels, out_channels):
        ...
        self.d_conv = nn.Sequential(nn.Conv2d(in_channels, out_channels, 3, padding=1), nn.ReLU(inplace=True), nn.Conv2d(out_channels, out_channels, 3, padding=1), nn.ReLU(inplace=True))
...
class Unet(nn.Module):
    ...
    def __init__(self, in_ch, out_ch):
        ...
        self.upsample2 = nn.Sequential(nn.ConvTranspose2d(128, 64, kernel_size=2, stride=2), nn.ReLU(inplace=True))
        self.upsample1 = nn.Sequential(nn.ConvTranspose2d(64, 32, kernel_size=2, stride=2), nn.ReLU(inplace=True))
