...
class VisionTransformerCLIP(nn.Module):
    ...
    def __init__(
        ...
        self.conv_shift = nn.Sequential(OrderedDict([("c_shift", nn.Conv2d(2, 64, kernel_size=(3, 57), stride=1, padding=(1,1), bias=False)), ("gelu", act_layer())]))

        self.conv1 = nn.Conv2d(in_channels=64, out_channels=width, kernel_size=patch_size, stride=patch_size, bias=False)
    ...
    def encode(self, measurement: torch.Tensor) -> torch.Tensor:
