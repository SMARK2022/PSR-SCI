...
class Diffusion(nn.Module):
    ...
    def __init__(self, timesteps=1000, beta_schedule="linear", loss_type="l2", linear_start=1e-4, linear_end=2e-2, cosine_s=8e-3, parameterization="eps"):
        super().__init__()
    ...
    def p_losses(self, model, x_start, t, cond):
        ...
        return loss_simple, x_noisy - model_output
